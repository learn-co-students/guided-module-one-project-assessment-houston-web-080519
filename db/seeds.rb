...
game = PartsOfSpeech.create(order_id: 3, story_id: story1.story_id, part_of_speech: "A Game")
...
n1 = PartsOfSpeech.create(order_id: 0, story_id: story1.story_id, part_of_speech: "Noun")
p2 = PartsOfSpeech.create(order_id: 1, story_id: story1.story_id, part_of_speech: "Place")
mot3 = PartsOfSpeech.create(order_id: 2, story_id: story1.story_id, part_of_speech: "Mode of Transportation")
n2 = PartsOfSpeech.create(order_id: 3, story_id: story1.story_id, part_of_speech: "Noun")
a1 = PartsOfSpeech.create(order_id: 4, story_id: story1.story_id, part_of_speech: "Adjective")
p3 = PartsOfSpeech.create(order_id: 5, story_id: story1.story_id, part_of_speech: "Place")
n4 = PartsOfSpeech.create(order_id: 6, story_id: story1.story_id, part_of_speech: "Noun")
f1 = PartsOfSpeech.create(order_id: 7, story_id: story1.story_id, part_of_speech: "Food")
p4 = PartsOfSpeech.create(order_id: 8, story_id: story1.story_id, part_of_speech: "Place")
n5 = PartsOfSpeech.create(order_id: 9, story_id: story1.story_id, part_of_speech: "Noun")
ft1 = PartsOfSpeech.create(order_id: 10, story_id: story1.story_id, part_of_speech: "Future Time (i.e. next weekend, next Christmas, etc.")
